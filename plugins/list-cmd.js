...
cmd({
    ...
    try {
        ...
        let menuText = `*┏────〘 𝐍𝐀𝐏𝐏𝐈𝐄𝐑-𝐗𝐌𝐃 〙───⊷*
*┃* *🛠️ BOT INFORMATION*
*┃* • 🤖 Bot Name: ${config.BOT_NAME}
*┃* • 👑 Owner: ${config.OWNER_NAME || 'lycifer'}
...
`
        ...
        menuText += `> ${config.DESCRIPTION || 'NAPPIER-XMD - Simple. Fast. Reliable.'}`

        await conn.sendMessage(
            from,
            {
                image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/99ofzd.jpg' },
                caption: menuText,
                contextInfo: {
