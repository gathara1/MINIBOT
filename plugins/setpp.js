...
cmd({
    ...
    try {
        ...
        if (!isOwner && (!isGroup || !isAdmins)) {
            return reply("❌ *NAPPIER-XMD, this command is restricted to Owner or Group Admins!*");
        }
        ...
        if (!/image/.test(mime)) {
            return reply("📸 *NAPPIER-XMD, please reply to an image to set it as the profile picture!*");
        }
...
🖼️ *Status:* Profile Picture Changed
👤 *Action by:* Nappier
🛡️ *Security:* Native Encryption
